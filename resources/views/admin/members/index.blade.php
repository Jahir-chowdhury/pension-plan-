@extends('layouts.admin.admin_master', ['title'=>'Members'])
...
@section('content')
    ...
    <div class="row justify-content-center">
        <form action="{{route('organization.members.show')}}">
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">@lang('Member Information Update')</h5>
        ...
        <div class="modal-body">
            @include('admin.members.update_form')
        </div>
    </div>
  </div>
</div>
...
<script>
    $(document).ready(function () {
        $(document).on('click', '.member-update-btn', function () {
            ...
            $("#input_member_id").val(memberObj.member_id);
            $("#input_date_of_birth").val(memberObj.date_of_birth);
            $("#input-member-department").val(memberObj.department);
            $("#input-member-designation").val(memberObj.designation);
            $("#input-employee_id").val(memberObj.emp_id);
