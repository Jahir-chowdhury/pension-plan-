@extends('layouts.admin.admin_master', ['title'=>'Asked For Rivew List'])
    ...
    <div class="row justify-content-center">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span class="pull-left"> List Of Settled Claim</span>
            </div>
            <div class="card-body">
                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                    ...
                    @forelse($claims as $claim)
                        <tr>
                            ...
                            <td><span class="badge bg-warning">{{$claim->claim_officer_remarks??$claim->doctor_remarks??$claim->hod_remarks??$claim->coo_remarks??$claim->ceo_remarks??'No Rivew'}}</span></td>
                            <td><span class="badge bg-success">{{$claim->claimsStatus->name}}</span></td>
                            <td>
                                <a href="{{route('claims.approve', ['id' => $claim->id])}}">
