@extends('layouts.admin.admin_master', ['title'=>'Member Information To Approve A Claim'])
    ...
    <div class="form-group">
        <div class="form-group">
            <div class="row">
                ...
                <div class="form-group col-sm-12 col-md-4">
                    <label for="select-employee-maritial-status" >@lang('Claim Type')</label>
                    <select name="claim_type" id="select-claim_type" class="form-control" value="{{old('claim_type')}}" readonly="readonly">
                        @foreach(App\Enums::CLAIM_TYPES as $key=>$status)
                ...
                <div class="form-group col-sm-12 col-md-4">
                    ...
                    <select name="claim_status" id="" class="form-control"readonly="readonly" value="{{old('claim_status')}}">
            ...
            <div class="row">
                <h5 class="modal-title" id="exampleModalLabel"class="required-label">@lang('Remarks Of Claim Officer')</h5>
                <div class="form-group col-sm-12 col-md-6">
                    {{-- <label for="" class="required-label">@lang('Remarks From Claim Officer')</label> --}}
                    <input type="text" class="form-control" name="claim_officer_remarks" value="{{$claim->claim_officer_remarks}}" id="input-claim_officer_remarks" readonly="readonly">
                    @error('claim_officer_remarks') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
            </div>
            <div class="row">
                <h5 class="modal-title" id="exampleModalLabel">@lang('Claim Process Informtion')</h5>
                <div class="form-group col-sm-12 col-md-6" >
                    <label for="remarks" class="required-label">@lang('Remarks For Approve/Rivew')</label>
                    <input type="text" class="form-control" name="remarks" value="" required>
                    @error('incident_remarks') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                <div class="form-group col-sm-12 col-md-6">
                    <label for="select-employee-maritial-status" class="required-label">@lang('Select for ')</label>
                        <select name="active_status" class="form-control">
                            <option value="{{App\Enums::CLAIM_APPROVE['APPROVE']}}">Approve</option>
                            <option value="{{App\Enums::CLAIM_APPROVE['REVIEW']}}">Review</option>
                        </select>
                    @error('maritial_status') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
            </div>
