@extends('layouts.admin.admin_master', ['title'=>'Claim document required'])
...
@section('content')
    ...
    <div class="row justify-content-center">
        <form action="{{route('claims.doc_required_index')}}">
                        ...
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            @forelse($claims as $claim)
                                <tr>
                                    ...
                                    <td><span class="badge bg-danger">{{$claim->claim_officer_remarks}}</span></td>
                                    <td>
                                        <span data-obj="{{$member=$claim->member}}" data-claim="{{$claim}}" class="badge bg-info  member-update-btn" style="cursor: pointer;">
                                            <b>Add File</b>
                                        </span>
                                    </td>
                                </tr>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        <div class="modal-body">
            @include('admin.claim.doc_required_form')
        </div>
    </div>
  </div>
</div>
