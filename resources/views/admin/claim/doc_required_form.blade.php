        ...
        <div class="form-group">
            <div class="row">
                <div class="form-group col-sm-12 col-md-4">
                    <label for="">@lang('Organization')</label>
            ...
            <div class="row">
                <h5 class="modal-title" id="exampleModalLabel">@lang('Add new file against a claim')</h5>
                <div class="form-group col-sm-12 col-md-6">
                    <label for="">@lang('Producer image Upload')</label>
                    <div class="controls">
