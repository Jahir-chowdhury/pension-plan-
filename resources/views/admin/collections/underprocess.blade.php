...
@endpush
@section('content')
    <h5 class="mb-3"><strong>Search by intimation number to see underprocessing list of EFT return </strong></h5>
    <div class="row p-3">
        @include('messages')
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card p-2">
                ...
                <div class="card-body">
                    <form action="{{ isset($formSubmissionUrl) ? $formSubmissionUrl : route('collection.eft.underprocess') }}"id="payment-form"
                        method="get">
                        <div class="row">
    ...
    @if(!empty($return_eft))
    <form action="{{route('collection.eft.underprocess')}}" method="get" enctype="multipart/form-data">
        @csrf
            <div class="row">
                ...
                <div class="mb-3 col-sm-12 col-md-4">
                    ...
                    <input class="form-control" name="bank_name" type="text" value="{{$return_eft->member->bank_name}}"readonly>
                </div>
                <div class="mb-3 col-sm-12 col-md-4">
                ...
                <div class="mb-3 col-sm-12 col-md-4">
                    ...
                    <input class="form-control" name="remarks" type="text" value="{{$return_eft->remarks}}"disabled>
                </div>
            </div>
            {{-- <div class="row">
                <div class="mb-3 col-sm-12 col-md-4">
